...
class CustomBot:
    def __init__(self, ROBOT_ID):
        ...
        self.distance_left = self.robot.getDevice("distancesensor left")
        self.distance_left.enable(self.timestep)
        self.distance_right = self.robot.getDevice("distancesensor right")
        self.distance_right.enable(self.timestep)
        self.distance_front = self.robot.getDevice("distancesensor front")
        self.distance_front.enable(self.timestep)
        self.distance_back = self.robot.getDevice("distancesensor back")
